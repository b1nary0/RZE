#include <StdAfx.h>
#include <Graphics/RenderPipelines/ForwardPipeline.h>
...
void ForwardRenderPipeline::Update(const std::vector<std::shared_ptr<RenderObject>>& renderObjects)
{
...
void ForwardRenderPipeline::Render(const std::vector<std::shared_ptr<RenderObject>>& renderObjects)
{
