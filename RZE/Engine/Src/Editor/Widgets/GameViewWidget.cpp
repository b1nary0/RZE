...
void GameViewWidget::Display()
{
	...
	if (ImGui::Begin("GameView", NULL, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse)) // #TODO(Josh) Why does the window need scroll bar?
	{
